...
router.post('/signup', async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      'INSERT INTO users (full_name, email, password_hash, role) VALUES ($1, $2, $3, COALESCE($4,\'student\')) ON CONFLICT (email) DO UPDATE SET full_name = EXCLUDED.full_name, password_hash = EXCLUDED.password_hash RETURNING id, full_name, email, role',
